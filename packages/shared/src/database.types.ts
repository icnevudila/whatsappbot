...
export type Database = {
  ...
  public: {
    Tables: {
      account_contacts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "account_contacts_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
      ...
      auto_reply_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "auto_reply_log_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auto_reply_log_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      auto_reply_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "auto_reply_rules_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      device_push_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "device_push_tokens_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_enter_organization: { Args: { p_org_id: string }; Returns: Json }
      ...
      resolve_org_api_key: { Args: { p_key: string }; Returns: string }
