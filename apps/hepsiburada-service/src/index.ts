...
import { CHANNEL, env, hasDatabase, loadHepsiburadaConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('hepsiburada-service', env.workerId)
...
export { env, loadHepsiburadaConfig, drainState }
