...
import { CHANNEL, env, hasDatabase, loadTicimaxConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('ticimax-service', env.workerId)
...
export { env, loadTicimaxConfig, drainState }
