...
import { CHANNEL, env, hasDatabase, loadMagentoConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('magento-service', env.workerId)
...
export { env, loadMagentoConfig, drainState }
