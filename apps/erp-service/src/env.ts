...
export const JOB_CHANNEL = 'sap,oracle,ifs,nebim' as const
...
export function loadErpConfig(overrides: Partial<ErpConfig> = {}): ErpConfig {
  return {
    ...
    provider: process.env.ERP_PROVIDER?.trim() || (Array.isArray(CHANNEL) ? CHANNEL[0]! : CHANNEL),
    ...overrides,
  }
}
