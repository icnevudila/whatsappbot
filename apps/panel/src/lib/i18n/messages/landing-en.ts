export const landingEn = {
  ...
  proof: [
    ...
    { label: '7-day trial', detail: 'No credit card required' },
  ],
  capacity: {
    kicker: 'Capacity',
  ...
  final: {
    title: 'Connect your first line in five minutes',
    lead: 'The Filo trial is fully featured. No credit card, no auto-renewal.',
    ctaPrimary: 'Try free for 7 days',
    ctaSecondary: 'See the product',
    hasAccount: 'Already have an account?',
    signIn: 'Sign in',
  },
  stickyCta: 'Try free for 7 days',
