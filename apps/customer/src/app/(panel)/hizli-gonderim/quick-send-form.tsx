        ...
        <div>
          ...
          {senders.length === 0 ? (
            <p className="rounded-md border border-hairline bg-canvas px-3 py-2 text-[12.5px] text-ink-faint">
              Bağlı hat yok. Önce{' '}
              <Link href="/ayarlar/hatlar" className="font-medium text-ink underline underline-offset-2">
                Hatlar
              </Link>{' '}
          ...
          {validCount > 0 && selected.length > 0 ? (
            overflow > 0 ? (
              <Notice tone="warn">
                ...
                <Link href="/ayarlar/hatlar" className="font-medium underline underline-offset-2">
                  ek hat bağlayın
                </Link>
                .
              </Notice>
