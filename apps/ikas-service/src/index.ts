...
import { CHANNEL, env, hasDatabase, loadIkasConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('ikas-service', env.workerId)
...
export { env, loadIkasConfig, drainState }
