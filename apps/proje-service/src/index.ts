...
import { CHANNEL, env, hasDatabase, loadProjeConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('proje-service', env.workerId)
...
export { env, loadProjeConfig, drainState }
