...
import { CHANNEL, env, hasDatabase, loadShopifyConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('shopify-service', env.workerId)
...
export { env, loadShopifyConfig, drainState }
