...
import { CHANNEL, env, hasDatabase, JOB_CHANNEL, loadCrmConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('crm-service', env.workerId)
...
export { env, loadCrmConfig, drainState }
