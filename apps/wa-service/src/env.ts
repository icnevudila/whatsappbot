...
export const env = {
  ...
  mediaCacheTtlSeconds: Math.max(0, int('MEDIA_CACHE_TTL_SECONDS', 600)),
  mediaCacheMaxKeys: Math.max(0, int('MEDIA_CACHE_MAX_KEYS', 200)),
  inboundMediaMaxBytes: Math.max(0, int('INBOUND_MEDIA_MAX_BYTES', 8 * 1024 * 1024)),
