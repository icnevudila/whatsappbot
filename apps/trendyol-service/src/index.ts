...
import { CHANNEL, env, hasDatabase, loadTrendyolConfig } from './env.js'
import { enqueueChannelJob, handleChannelJob } from './job-handlers.js'

const logger = createWorkerLogger('trendyol-service', env.workerId)
...
export { env, loadTrendyolConfig, drainState }
